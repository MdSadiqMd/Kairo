...
output "efs_file_system_id" {
  description = "EFS file system ID for adapter storage (empty when disabled)."
  value       = module.efs.file_system_id
}

output "efs_enabled" {
  description = "Whether EFS for adapter storage is provisioned."
  value       = tostring(module.efs.enabled)
}
