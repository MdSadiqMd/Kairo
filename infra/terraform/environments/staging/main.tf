# Staging environment root. Modules resolve in dependency order via references:
...
#
# Staging config:
# - 2 AZs (us-west-2a/b) sufficient for integration testing
# - EKS endpoint private-only
# - DynamoDB deletion_protection = true
# - S3 force_destroy = false (prod-like data protection)
# - log_retention_days = 90
# - Spot allowed for training workloads (cost saving)
# - Full canary flow: shadow -> 1% -> 10% -> full
